...
uint256 hashGenesisBlock("0xe2052595c190cc6864d0d132c49ea370d56bfacbcf6930717a807cd1c06dce2c");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Indiacoin: starting difficulty is 1 / 2^12
...
{
    // Indiacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 210000); // Indiacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Indiacoin: 3.5 days
static const int64 nTargetSpacing = 150; // Indiacoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Indiacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Indiacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Indiacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xec0df632d1bd0905ee457d812812c3055744e50d5b6083efd2afb2ca5c06638c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("2ebe14b0ca7f6d73624577395ef191d293cb336fd5f1ff77e36ac92d8bce04f88b7ca1d9badb27390e3ffbbdad9c12521e92eb726fef8910714af84c3f4cabede4") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1467766900;
        block.nBits    = 504365644;
        block.nNonce   = 3007460754;

        if (fTestNet)
        {
            block.nTime    = 1467766900;
            block.nNonce   = 53267234;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x74d3fdf6b0e6833fd29cd147d093605811f6727582f53bc00b1df489c782a130"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Indiacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("IndiacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("IndiacoinMiner : ProcessBlock, block not accepted");
    }
